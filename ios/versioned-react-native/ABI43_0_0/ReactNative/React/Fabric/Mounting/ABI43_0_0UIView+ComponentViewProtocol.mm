...
#import "ABI43_0_0UIView+ComponentViewProtocol.h"
...
{
  ABI43_0_0RCTAssert(NO, @"`-[ABI43_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented in a concrete class.");
  return {};
}
           ...
           oldLayoutMetrics:(LayoutMetrics const &)oldLayoutMetrics
{
  ...
  if (forceUpdate || (layoutMetrics.frame != oldLayoutMetrics.frame)) {
    CGRect frame = ABI43_0_0RCTCGRectFromRect(layoutMetrics.frame);
...
{
  ABI43_0_0RCTAssert(NO, @"props access should be implemented by ABI43_0_0RCTViewComponentView.");
  return nullptr;
}
