...
#import <ABI43_0_0React/ABI43_0_0RCTTouchableComponentViewProtocol.h>
#import <ABI43_0_0React/ABI43_0_0UIView+ComponentViewProtocol.h>
...
#import <ABI43_0_0React/ABI43_0_0renderer/core/EventEmitter.h>
#import <ABI43_0_0React/ABI43_0_0renderer/core/LayoutMetrics.h>
#import <ABI43_0_0React/ABI43_0_0renderer/core/Props.h>
 ...
 */
@interface ABI43_0_0RCTViewComponentView : UIView <ABI43_0_0RCTComponentViewProtocol, ABI43_0_0RCTTouchableComponentViewProtocol> {
 @protected
  ABI43_0_0facebook::ABI43_0_0React::LayoutMetrics _layoutMetrics;
  ABI43_0_0facebook::ABI43_0_0React::SharedViewProps _props;
  ABI43_0_0facebook::ABI43_0_0React::SharedViewEventEmitter _eventEmitter;
}
...
/**
 * Enforcing `call super` semantic for overridden methods from `ABI43_0_0RCTComponentViewProtocol`.
 * The methods update the instance variables.
 */
- (void)updateProps:(ABI43_0_0facebook::ABI43_0_0React::Props::Shared const &)props
           oldProps:(ABI43_0_0facebook::ABI43_0_0React::Props::Shared const &)oldProps NS_REQUIRES_SUPER;
- (void)updateEventEmitter:(ABI43_0_0facebook::ABI43_0_0React::EventEmitter::Shared const &)eventEmitter NS_REQUIRES_SUPER;
- (void)updateLayoutMetrics:(ABI43_0_0facebook::ABI43_0_0React::LayoutMetrics const &)layoutMetrics
           oldLayoutMetrics:(ABI43_0_0facebook::ABI43_0_0React::LayoutMetrics const &)oldLayoutMetrics NS_REQUIRES_SUPER;
- (void)finalizeUpdates:(ABI43_0_0RNComponentViewUpdateMask)updateMask NS_REQUIRES_SUPER;
