...
#import <ABI43_0_0React/ABI43_0_0renderer/components/view/ViewEventEmitter.h>
#import <ABI43_0_0React/ABI43_0_0renderer/components/view/ViewProps.h>

using namespace ABI43_0_0facebook::ABI43_0_0React;

@implementation ABI43_0_0RCTViewComponentView {
...
- (void)setContentView:(UIView *)contentView
{
  ...
  if (_contentView) {
    ...
    _contentView.frame = ABI43_0_0RCTCGRectFromRect(_layoutMetrics.getContentFrame());
  }
}
...
{
  ABI43_0_0RCTAssert(
      self == [ABI43_0_0RCTViewComponentView class],
      @"`+[ABI43_0_0RCTComponentViewProtocol componentDescriptorProvider]` must be implemented for all subclasses (and `%@` particularly).",
...
{
  ABI43_0_0RCTAssert(props, @"`props` must not be `null`.");

#ifndef NS_BLOCK_ASSERTIONS
  auto propsRawPtr = _props.get();
  ABI43_0_0RCTAssert(
      propsRawPtr &&
          ([self class] == [ABI43_0_0RCTViewComponentView class] ||
           typeid(*propsRawPtr).hash_code() != typeid(ViewProps const).hash_code()),
      @"`ABI43_0_0RCTViewComponentView` subclasses (and `%@` particularly) must setup `_props`"
  ...
  if (oldViewProps.backgroundColor != newViewProps.backgroundColor) {
    self.backgroundColor = ABI43_0_0RCTUIColorFromSharedColor(newViewProps.backgroundColor);
    needsInvalidateLayer = YES;
  }

  // `foregroundColor`
  if (oldViewProps.foregroundColor != newViewProps.foregroundColor) {
    self.foregroundColor = ABI43_0_0RCTUIColorFromSharedColor(newViewProps.foregroundColor);
  }

  // `shadowColor`
  if (oldViewProps.shadowColor != newViewProps.shadowColor) {
    CGColorRef shadowColor = ABI43_0_0RCTCreateCGColorRefFromSharedColor(newViewProps.shadowColor);
  ...
  if (oldViewProps.shadowOffset != newViewProps.shadowOffset) {
    self.layer.shadowOffset = ABI43_0_0RCTCGSizeFromSize(newViewProps.shadowOffset);
    needsInvalidateLayer = YES;
  }
  ...
  if (oldViewProps.transform != newViewProps.transform &&
    ...
    self.layer.transform = ABI43_0_0RCTCATransform3DFromTransformMatrix(newViewProps.transform);
  ...
  if (oldViewProps.nativeId != newViewProps.nativeId) {
    self.nativeId = ABI43_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.nativeId);
  }
  ...
  if (oldViewProps.accessibilityLabel != newViewProps.accessibilityLabel) {
    self.accessibilityElement.accessibilityLabel = ABI43_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityLabel);
  }

  // `accessibilityHint`
  if (oldViewProps.accessibilityHint != newViewProps.accessibilityHint) {
    self.accessibilityElement.accessibilityHint = ABI43_0_0RCTNSStringFromStringNilIfEmpty(newViewProps.accessibilityHint);
  }
  ...
  if (oldViewProps.accessibilityTraits != newViewProps.accessibilityTraits) {
    self.accessibilityElement.accessibilityTraits =
        ABI43_0_0RCTUIAccessibilityTraitsFromAccessibilityTraits(newViewProps.accessibilityTraits);
  }
...
- (void)prepareForRecycle
{
  ...
  if ([_propKeysManagedByAnimated_DO_NOT_USE_THIS_IS_BROKEN containsObject:@"transform"]) {
    self.layer.transform = ABI43_0_0RCTCATransform3DFromTransformMatrix(props.transform);
  }
...
- (UIView *)betterHitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  if (ABI43_0_0RCTExperimentGetOptimizedHitTesting()) {
...
static ABI43_0_0RCTCornerRadii ABI43_0_0RCTCornerRadiiFromBorderRadii(BorderRadii borderRadii)
{
  return ABI43_0_0RCTCornerRadii{.topLeft = (CGFloat)borderRadii.topLeft,
...
static ABI43_0_0RCTBorderColors ABI43_0_0RCTCreateABI43_0_0RCTBorderColorsFromBorderColors(BorderColors borderColors)
{
  return ABI43_0_0RCTBorderColors{.top = ABI43_0_0RCTCreateCGColorRefFromSharedColor(borderColors.top),
                         .left = ABI43_0_0RCTCreateCGColorRefFromSharedColor(borderColors.left),
                         .bottom = ABI43_0_0RCTCreateCGColorRefFromSharedColor(borderColors.bottom),
                         .right = ABI43_0_0RCTCreateCGColorRefFromSharedColor(borderColors.right)};
}

static void ABI43_0_0RCTReleaseABI43_0_0RCTBorderColors(ABI43_0_0RCTBorderColors borderColors)
{
...
static ABI43_0_0RCTBorderStyle ABI43_0_0RCTBorderStyleFromBorderStyle(BorderStyle borderStyle)
{
  switch (borderStyle) {
    case BorderStyle::Solid:
      return ABI43_0_0RCTBorderStyleSolid;
    case BorderStyle::Dotted:
      return ABI43_0_0RCTBorderStyleDotted;
    case BorderStyle::Dashed:
      return ABI43_0_0RCTBorderStyleDashed;
  }
}
...
- (void)invalidateLayer
{
  ...
  if (layerHasShadow) {
    if (CGColorGetAlpha(_backgroundColor.CGColor) > 0.999) {
      ...
      ABI43_0_0RCTCornerInsets const cornerInsets =
          ABI43_0_0RCTGetCornerInsets(ABI43_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero);
      CGPathRef shadowPath = ABI43_0_0RCTPathCreateWithRoundedRect(self.bounds, cornerInsets, nil);
  ...
  if (useCoreAnimationBorderRendering) {
    ...
    CGColorRef borderColor = ABI43_0_0RCTCreateCGColorRefFromSharedColor(borderMetrics.borderColors.left);
    ...
    ABI43_0_0RCTBorderColors borderColors = ABI43_0_0RCTCreateABI43_0_0RCTBorderColorsFromBorderColors(borderMetrics.borderColors);

    UIImage *image = ABI43_0_0RCTGetBorderImage(
        ABI43_0_0RCTBorderStyleFromBorderStyle(borderMetrics.borderStyles.left),
        layer.bounds.size,
        ABI43_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii),
        ABI43_0_0RCTUIEdgeInsetsFromEdgeInsets(borderMetrics.borderWidths),
        borderColors,
        _backgroundColor.CGColor,
        self.clipsToBounds);

    ABI43_0_0RCTReleaseABI43_0_0RCTBorderColors(borderColors);
    ...
    if (self.clipsToBounds) {
      if (borderMetrics.borderRadii.isUniform()) {
        ...
        CGPathRef path = ABI43_0_0RCTPathCreateWithRoundedRect(
            self.bounds,
            ABI43_0_0RCTGetCornerInsets(ABI43_0_0RCTCornerRadiiFromBorderRadii(borderMetrics.borderRadii), UIEdgeInsetsZero),
            nil);
...
static NSString *ABI43_0_0RCTRecursiveAccessibilityLabel(UIView *view)
{
  NSMutableString *result = [NSMutableString stringWithString:@""];
  for (UIView *subview in view.subviews) {
    NSString *label = subview.accessibilityLabel;
    if (!label) {
      label = ABI43_0_0RCTRecursiveAccessibilityLabel(subview);
    }
...
- (NSString *)accessibilityLabel
{
  ...
  return ABI43_0_0RCTRecursiveAccessibilityLabel(self);
}
...
- (NSArray<UIAccessibilityCustomAction *> *)accessibilityCustomActions
{
  ...
  for (auto const &accessibilityAction : accessibilityActions) {
    [customActions
        addObject:[[UIAccessibilityCustomAction alloc] initWithName:ABI43_0_0RCTNSStringFromString(accessibilityAction)
                                                             target:self
...
- (BOOL)didActivateAccessibilityCustomAction:(UIAccessibilityCustomAction *)action
{
  if (_eventEmitter && _props->onAccessibilityAction) {
    _eventEmitter->onAccessibilityAction(ABI43_0_0RCTStringFromNSString(action.name));
    return YES;
  } else {
    return NO;
  }
...
{
  return ABI43_0_0RCTNSStringFromString([[self class] componentDescriptorProvider].name);
}
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTViewCls(void);
...
Class<ABI43_0_0RCTComponentViewProtocol> ABI43_0_0RCTViewCls(void)
{
  return ABI43_0_0RCTViewComponentView.class;
}
