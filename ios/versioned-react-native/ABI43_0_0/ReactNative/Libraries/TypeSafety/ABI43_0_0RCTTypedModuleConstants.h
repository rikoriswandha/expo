...
/**
 * Interop type layer for ABI43_0_0RN's exportedConstants and the C++ structs generated by our typesafety codegen.
 *
 * The ABI43_0_0NativeModuleSpec will define a constantsToExport method which you can implement as follows:
 *
...
@interface _ABI43_0_0RCTTypedModuleConstants<StructType> : NSDictionary<NSString *, id>
...
template<typename T>
using ModuleConstants = _ABI43_0_0RCTTypedModuleConstants<void (^)(T)> *;

template<typename T>
ModuleConstants<T> typedConstants(typename T::Builder::Input &&value) {
  typename T::Builder builder(std::move(value));
  return [_ABI43_0_0RCTTypedModuleConstants newWithUnsafeDictionary:builder.buildUnsafeRawValue()];
}
