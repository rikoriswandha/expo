...
struct Transform {
   ...
   */
#ifdef ABI43_0_0RN_DEBUG_STRING_CONVERTIBLE
...
template <>
struct hash<ABI43_0_0facebook::ABI43_0_0React::Transform> {
  size_t operator()(const ABI43_0_0facebook::ABI43_0_0React::Transform &transform) const {
