...
#ifndef NDEBUG
#define ABI43_0_0RN_DEBUG_STRING_CONVERTIBLE 1
#endif

// To Debug Yoga layout, uncomment the following line.
// #define ABI43_0_0RN_DEBUG_YOGA_LOGGER 1
//
// Additional logging can be enabled editing yoga.cpp (e.g. gPrintChanges,
// gPrintSkips)

// To Debug introspection of ABI43_0_0RN Shadow tree, uncomment the following line:
// #define ABI43_0_0RN_SHADOW_TREE_INTROSPECTION 1

// To enable asserts (crashing) when checking stub trees
// #define ABI43_0_0RN_VALIDATE_SHADOW_TREE_STUB 1
