...
#define JSC_LIKELY(ABI43_0_0EXPR) __builtin_expect((bool)(ABI43_0_0EXPR), true)
#define JSC_UNLIKELY(ABI43_0_0EXPR) __builtin_expect((bool)(ABI43_0_0EXPR), false)
#else
#define JSC_LIKELY(ABI43_0_0EXPR) (ABI43_0_0EXPR)
#define JSC_UNLIKELY(ABI43_0_0EXPR) (ABI43_0_0EXPR)
#endif
