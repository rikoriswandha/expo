...
#import <ABI43_0_0EXSensors/ABI43_0_0EXSensorsManager.h>
#import <CoreMotion/CoreMotion.h>

@interface ABI43_0_0EXSensorsManager ()
...
@implementation ABI43_0_0EXSensorsManager

ABI43_0_0EX_REGISTER_MODULE();

+ (const NSArray<Protocol *> *)exportedInterfaces
{
  return @[@protocol(ABI43_0_0EXAccelerometerInterface), @protocol(ABI43_0_0EXBarometerInterface), @protocol(ABI43_0_0EXDeviceMotionInterface), @protocol(ABI43_0_0EXGyroscopeInterface), @protocol(ABI43_0_0EXMagnetometerInterface), @protocol(ABI43_0_0EXMagnetometerUncalibratedInterface)];
}
                                            ...
                                            withHandler:(void (^)(NSDictionary *event))handlerBlock
{
  ...
  if (![[self manager] isAccelerometerActive]) {
    ...
    __weak ABI43_0_0EXSensorsManager *weakSelf = self;
    [[self manager] startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue] withHandler:^(CMAccelerometerData *data, NSError *error) {
      __strong ABI43_0_0EXSensorsManager *strongSelf = weakSelf;
      if (strongSelf) {
  ...
  [[self manager] startDeviceMotionUpdatesUsingReferenceFrame:CMAttitudeReferenceFrameXArbitraryCorrectedZVertical toQueue:[NSOperationQueue mainQueue] withHandler:^(CMDeviceMotion *data, NSError *error) {
    ...
    NSMutableDictionary *result = [NSMutableDictionary dictionaryWithDictionary:@{
                             ...
                             @"accelerationIncludingGravity": @{
                                 @"x": @((data.userAcceleration.x + data.gravity.x) * ABI43_0_0EXGravity),
                                 @"y": @((data.userAcceleration.y + data.gravity.y) * ABI43_0_0EXGravity),
                                 @"z": @((data.userAcceleration.z + data.gravity.z) * ABI43_0_0EXGravity)
                                 },
                             @"rotation": @{
    ...
    if ([[strongSelf manager] isGyroAvailable]) {
      result[@"acceleration"] = @{
        @"x": @(data.userAcceleration.x * ABI43_0_0EXGravity),
        @"y": @(data.userAcceleration.y * ABI43_0_0EXGravity),
        @"z": @(data.userAcceleration.z * ABI43_0_0EXGravity)
      };
