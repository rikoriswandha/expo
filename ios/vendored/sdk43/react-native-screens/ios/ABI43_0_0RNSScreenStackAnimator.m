...
@implementation ABI43_0_0RNSScreenStackAnimator {
...
- (NSTimeInterval)transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext
{
  ...
  if (_operation == UINavigationControllerOperationPush) {
    ...
    screen = (ABI43_0_0RNSScreenView *)toViewController.view;
  } else if (_operation == UINavigationControllerOperationPop) {
    UIViewController *fromViewController =
    [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    screen = (ABI43_0_0RNSScreenView *)fromViewController.view;
  }
  
  if (screen != nil && screen.stackAnimation == ABI43_0_0RNSScreenStackAnimationNone) {
    return 0;
  }
...
{
  return (animation != ABI43_0_0RNSScreenStackAnimationFlip && animation != ABI43_0_0RNSScreenStackAnimationDefault);
}

- (void)animateTransitionWithStackAnimation:(ABI43_0_0RNSScreenStackAnimation)animation
                          transitionContext:(id<UIViewControllerContextTransitioning>)transitionContext
                                       toVC:(UIViewController *)toVC
                                     fromVC:(UIViewController *)fromVC
{
  if (animation == ABI43_0_0RNSScreenStackAnimationSimplePush) {
    [self animateSimplePushWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI43_0_0RNSScreenStackAnimationFade || animation == ABI43_0_0RNSScreenStackAnimationNone) {
    [self animateFadeWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI43_0_0RNSScreenStackAnimationSlideFromBottom) {
    [self animateSlideFromBottomWithTransitionContext:transitionContext toVC:toVC fromVC:fromVC];
    return;
  } else if (animation == ABI43_0_0RNSScreenStackAnimationFadeFromBottom) {
