...
@implementation ABI43_0_0RNSScreenWindowTraits
...
+ (void)assertViewControllerBasedStatusBarAppearenceSet
{
  ...
  if (!viewControllerBasedAppearence) {
    ABI43_0_0RCTLogError(@"If you want to change the appearance of status bar, you have to change \
...
__IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
  if (@available(iOS 13.0, *)) {
    switch (statusBarStyle) {
      case ABI43_0_0RNSStatusBarStyleAuto:
        return [UITraitCollection.currentTraitCollection userInterfaceStyle] == UIUserInterfaceStyleDark
        ? UIStatusBarStyleLightContent
        : UIStatusBarStyleDarkContent;
      case ABI43_0_0RNSStatusBarStyleInverted:
        return [UITraitCollection.currentTraitCollection userInterfaceStyle] == UIUserInterfaceStyleDark
        ? UIStatusBarStyleDarkContent
        : UIStatusBarStyleLightContent;
      case ABI43_0_0RNSStatusBarStyleLight:
        return UIStatusBarStyleLightContent;
      case ABI43_0_0RNSStatusBarStyleDark:
  ...
  if (statusBarStyle == ABI43_0_0RNSStatusBarStyleLight) {
    return UIStatusBarStyleLightContent;
  }
...
__IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
    ...
    [ABI43_0_0RNSScreenWindowTraits interfaceOrientationFromDeviceOrientation:[[UIDevice currentDevice] orientation]];
    UIInterfaceOrientation currentInterfaceOrientation = [ABI43_0_0RNSScreenWindowTraits interfaceOrientation];
    UIInterfaceOrientation newOrientation = UIInterfaceOrientationUnknown;
    if ([ABI43_0_0RNSScreenWindowTraits maskFromOrientation:currentDeviceOrientation] & orientationMask) {
      if (!([ABI43_0_0RNSScreenWindowTraits maskFromOrientation:currentInterfaceOrientation] & orientationMask)) {
      ...
      if (!([ABI43_0_0RNSScreenWindowTraits maskFromOrientation:currentInterfaceOrientation] & orientationMask)) {
        ...
        // rotation from mask
        newOrientation = [ABI43_0_0RNSScreenWindowTraits defaultOrientationForOrientationMask:orientationMask];
      } else {
