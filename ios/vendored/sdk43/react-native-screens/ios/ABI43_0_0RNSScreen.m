...
@interface ABI43_0_0RNSScreenView () <UIAdaptivePresentationControllerDelegate, ABI43_0_0RCTInvalidating>
@end

@implementation ABI43_0_0RNSScreenView {
  __weak ABI43_0_0RCTBridge *_bridge;
  ABI43_0_0RNSScreen *_controller;
...
- (instancetype)initWithBridge:(ABI43_0_0RCTBridge *)bridge
{
  if (self = [super init]) {
    _bridge = bridge;
    _controller = [[ABI43_0_0RNSScreen alloc] initWithView:self];
    _stackPresentation = ABI43_0_0RNSScreenStackPresentationPush;
    _stackAnimation = ABI43_0_0RNSScreenStackAnimationDefault;
    _gestureEnabled = YES;
    _replaceAnimation = ABI43_0_0RNSScreenReplaceAnimationPop;
    _dismissed = NO;
...
{
  _reactFrame = frame;
  UIViewController *parentVC = self.ABI43_0_0ReactViewController.parentViewController;
  if (parentVC != nil && ![parentVC isKindOfClass:[ABI43_0_0RNScreensNavigationController class]]) {
    [super ABI43_0_0ReactSetFrame:frame];
  }
  // when screen is mounted under ABI43_0_0RNScreensNavigationController it's size is controller
...
- (void)setActivityStateOrNil:(NSNumber *)activityStateOrNil
{
  ...
  if (activityStateOrNil != nil && activityState != _activityState) {
    ...
    [_ABI43_0_0ReactSuperview markChildUpdated];
  }
}
...
- (void)setPointerEvents:(ABI43_0_0RCTPointerEvents)pointerEvents
{
  ...
  // any attempt of setting that via ABI43_0_0React props
}

- (void)setStackPresentation:(ABI43_0_0RNSScreenStackPresentation)stackPresentation
{
  switch (stackPresentation) {
    case ABI43_0_0RNSScreenStackPresentationModal:
...
__IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
...
#endif
      break;
    case ABI43_0_0RNSScreenStackPresentationFullScreenModal:
      _controller.modalPresentationStyle = UIModalPresentationFullScreen;
      break;
#if !TARGET_OS_TV
    case ABI43_0_0RNSScreenStackPresentationFormSheet:
      _controller.modalPresentationStyle = UIModalPresentationFormSheet;
      break;
#endif
    case ABI43_0_0RNSScreenStackPresentationTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverFullScreen;
      break;
    case ABI43_0_0RNSScreenStackPresentationContainedModal:
      _controller.modalPresentationStyle = UIModalPresentationCurrentContext;
      break;
    case ABI43_0_0RNSScreenStackPresentationContainedTransparentModal:
      _controller.modalPresentationStyle = UIModalPresentationOverCurrentContext;
      break;
    case ABI43_0_0RNSScreenStackPresentationPush:
  ...
  if (stackPresentation != ABI43_0_0RNSScreenStackPresentationPush) {
  ...
  } else if (_stackPresentation != ABI43_0_0RNSScreenStackPresentationPush) {
...
- (void)setStackAnimation:(ABI43_0_0RNSScreenStackAnimation)stackAnimation
{
  _stackAnimation = stackAnimation;
  
  switch (stackAnimation) {
    case ABI43_0_0RNSScreenStackAnimationFade:
      _controller.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
      break;
#if !TARGET_OS_TV
    case ABI43_0_0RNSScreenStackAnimationFlip:
      _controller.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
      break;
#endif
    case ABI43_0_0RNSScreenStackAnimationNone:
    case ABI43_0_0RNSScreenStackAnimationDefault:
    case ABI43_0_0RNSScreenStackAnimationSimplePush:
    case ABI43_0_0RNSScreenStackAnimationSlideFromBottom:
    case ABI43_0_0RNSScreenStackAnimationFadeFromBottom:
      // Default
      break;
  }
}
...
- (void)setReplaceAnimation:(ABI43_0_0RNSScreenReplaceAnimation)replaceAnimation
{
  _replaceAnimation = replaceAnimation;
}

#if !TARGET_OS_TV
- (void)setStatusBarStyle:(ABI43_0_0RNSStatusBarStyle)statusBarStyle
{
  _hasStatusBarStyleSet = YES;
  _statusBarStyle = statusBarStyle;
  [ABI43_0_0RNSScreenWindowTraits assertViewControllerBasedStatusBarAppearenceSet];
  [ABI43_0_0RNSScreenWindowTraits updateStatusBarAppearance];
}
...
- (void)setScreenOrientation:(UIInterfaceOrientationMask)screenOrientation
{
  ...
  [ABI43_0_0RNSScreenWindowTraits enforceDesiredDeviceOrientation];
}
#endif

- (UIView *)ABI43_0_0ReactSuperview
{
  return _ABI43_0_0ReactSuperview;
}

- (void)addSubview:(UIView *)view
{
  if (![view isKindOfClass:[ABI43_0_0RNSScreenStackHeaderConfig class]]) {
    [super addSubview:view];
  } else {
    ((ABI43_0_0RNSScreenStackHeaderConfig *)view).screenView = self;
  }
}
...
- (void)notifyWillAppear
{
  ...
  [self ABI43_0_0ReactSetFrame:_reactFrame];
}
...
- (BOOL)isMountedUnderScreenOrReactRoot
{
  for (UIView *parent = self.superview; parent != nil; parent = parent.superview) {
    if ([parent isKindOfClass:[ABI43_0_0RCTRootView class]] || [parent isKindOfClass:[ABI43_0_0RNSScreenView class]]) {
      return YES;
    }
  }
  return NO;
...
{
  // For RN touches to work we need to instantiate and connect ABI43_0_0RCTTouchHandler. This only applies
  // for screens that aren't mounted under ABI43_0_0RCTRootView e.g., modals that are mounted directly to
...
- (void)presentationControllerWillDismiss:(UIPresentationController *)presentationController
{
  ...
  // Because of that, at the moment when this method gets called the ABI43_0_0React's
  // gesture recognizer is already in FAILED state but cancel events never gets
  // send to JS. Calling "reset" forces ABI43_0_0RCTTouchHanler to dispatch cancel event.
...
- (ABI43_0_0RCTTouchHandler *)touchHandler
{
  if (_touchHandler != nil) {
...
{
  if ([_ABI43_0_0ReactSuperview respondsToSelector:@selector(presentationControllerDidDismiss:)]) {
    [_ABI43_0_0ReactSuperview performSelector:@selector(presentationControllerDidDismiss:) withObject:presentationController];
  }
}
...
@implementation ABI43_0_0RNSScreen {
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI43_0_0RNSWindowTraitStyle includingModals:NO];
  return vc == self ? nil : vc;
}

- (UIStatusBarStyle)preferredStatusBarStyle
{
  return [ABI43_0_0RNSScreenWindowTraits statusBarStyleForRNSStatusBarStyle:((ABI43_0_0RNSScreenView *)self.view).statusBarStyle];
}

- (UIViewController *)childViewControllerForStatusBarHidden
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI43_0_0RNSWindowTraitHidden includingModals:NO];
  return vc == self ? nil : vc;
}

- (BOOL)prefersStatusBarHidden
{
  return ((ABI43_0_0RNSScreenView *)self.view).statusBarHidden;
}

- (UIStatusBarAnimation)preferredStatusBarUpdateAnimation
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI43_0_0RNSWindowTraitAnimation includingModals:NO];
  
  if ([vc isKindOfClass:[ABI43_0_0RNSScreen class]]) {
    return ((ABI43_0_0RNSScreenView *)vc.view).statusBarAnimation;
  }
...
{
  UIViewController *vc = [self findChildVCForConfigAndTrait:ABI43_0_0RNSWindowTraitOrientation includingModals:YES];
  
  if ([vc isKindOfClass:[ABI43_0_0RNSScreen class]]) {
    return ((ABI43_0_0RNSScreenView *)vc.view).screenOrientation;
  }
...
- (UIViewController *)findChildVCForConfigAndTrait:(ABI43_0_0RNSWindowTrait)trait includingModals:(BOOL)includingModals
{
  ...
  if ([self.presentedViewController isKindOfClass:[ABI43_0_0RNSScreen class]]) {
    ...
    ? nil
    : [(ABI43_0_0RNSScreen *)lastViewController findChildVCForConfigAndTrait:trait includingModals:includingModals]
    ?: lastViewController;
  }
  ...
  if (lastViewController == nil) {
    ...
    if ([lastViewController conformsToProtocol:@protocol(ABI43_0_0RNScreensViewControllerDelegate)]) {
      ...
      if ([childScreen isKindOfClass:[ABI43_0_0RNSScreen class]]) {
        return [(ABI43_0_0RNSScreen *)childScreen findChildVCForConfigAndTrait:trait includingModals:includingModals]
        ?: selfOrNil;
      } else {
        return selfOrNil;
      }
...
- (BOOL)hasTraitSet:(ABI43_0_0RNSWindowTrait)trait
{
  switch (trait) {
    case ABI43_0_0RNSWindowTraitStyle: {
      return ((ABI43_0_0RNSScreenView *)self.view).hasStatusBarStyleSet;
    }
    case ABI43_0_0RNSWindowTraitAnimation: {
      return ((ABI43_0_0RNSScreenView *)self.view).hasStatusBarAnimationSet;
    }
    case ABI43_0_0RNSWindowTraitHidden: {
      return ((ABI43_0_0RNSScreenView *)self.view).hasStatusBarHiddenSet;
    }
    case ABI43_0_0RNSWindowTraitOrientation: {
      return ((ABI43_0_0RNSScreenView *)self.view).hasOrientationSet;
    }
    default: {
      ABI43_0_0RCTLogError(@"Unknown trait passed: %d", (int)trait);
    }
  }
  return NO;
}
...
- (void)viewDidLayoutSubviews
{
  ...
  // into account only when the view is mounted under ABI43_0_0RNScreensNavigationController in which case system
  ...
  [self.parentViewController isKindOfClass:[ABI43_0_0RNScreensNavigationController class]];
  ...
  if ((isDisplayedWithinUINavController || isPresentedAsNativeModal) &&
    ...
    [((ABI43_0_0RNSScreenView *)self.viewIfLoaded) updateBounds];
  }
}
...
- (void)viewWillAppear:(BOOL)animated
{
  ...
  if (!_isSwiping) {
    [((ABI43_0_0RNSScreenView *)self.view) notifyWillAppear];
...
- (void)viewWillDisappear:(BOOL)animated
{
  ...
  if (!_isSwiping) {
    [((ABI43_0_0RNSScreenView *)self.view) notifyWillDisappear];
    if (self.transitionCoordinator.isInteractive) {
      _isSwiping = YES;
    }
  } else {
...
- (void)viewDidAppear:(BOOL)animated
{
  ...
  if (!_isSwiping || _shouldNotify) {
    ...
    [((ABI43_0_0RNSScreenView *)self.view) notifyAppear];
...
- (void)viewDidDisappear:(BOOL)animated
{
  ...
  if (self.parentViewController == nil && self.presentingViewController == nil) {
    if (((ABI43_0_0RNSScreenView *)self.view).preventNativeDismiss) {
      ...
      [((ABI43_0_0RNSScreenView *)self.view).ABI43_0_0ReactSuperview updateContainer];
      [((ABI43_0_0RNSScreenView *)self.view) notifyDismissCancelledWithDismissCount:_dismissCount];
    } else {
      // screen dismissed, send event
      [((ABI43_0_0RNSScreenView *)self.view) notifyDismissedWithCount:_dismissCount];
    }
  }
  
  // same flow as in viewDidAppear
  if (!_isSwiping || _shouldNotify) {
    [((ABI43_0_0RNSScreenView *)self.view) notifyDisappear];
...
{
  return (int)[[self.view.ABI43_0_0ReactSuperview ABI43_0_0ReactSubviews] indexOfObject:view];
}

- (int)getParentChildrenCount
{
  return (int)[[self.view.ABI43_0_0ReactSuperview ABI43_0_0ReactSubviews] count];
}
...
- (void)notifyTransitionProgress:(double)progress closing:(BOOL)closing goingForward:(BOOL)goingForward
{
  [((ABI43_0_0RNSScreenView *)self.view) notifyTransitionProgress:progress closing:closing goingForward:goingForward];
}

@end

@implementation ABI43_0_0RNSScreenManager

ABI43_0_0RCT_EXPORT_MODULE()

// we want to handle the case when activityState is nil
ABI43_0_0RCT_REMAP_VIEW_PROPERTY(activityState, activityStateOrNil, NSNumber)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(customAnimationOnSwipe, BOOL);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(fullScreenSwipeEnabled, BOOL);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(gestureEnabled, BOOL)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(preventNativeDismiss, BOOL)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(replaceAnimation, ABI43_0_0RNSScreenReplaceAnimation)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(stackPresentation, ABI43_0_0RNSScreenStackPresentation)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(stackAnimation, ABI43_0_0RNSScreenStackAnimation)

ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onAppear, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onDisappear, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onDismissed, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onNativeDismissCancelled, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onTransitionProgress, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onWillAppear, ABI43_0_0RCTDirectEventBlock);
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(onWillDisappear, ABI43_0_0RCTDirectEventBlock);

#if !TARGET_OS_TV
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(screenOrientation, UIInterfaceOrientationMask)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarAnimation, UIStatusBarAnimation)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarHidden, BOOL)
ABI43_0_0RCT_EXPORT_VIEW_PROPERTY(statusBarStyle, ABI43_0_0RNSStatusBarStyle)
#endif

- (UIView *)view
{
  return [[ABI43_0_0RNSScreenView alloc] initWithBridge:self.bridge];
}

@end

@implementation ABI43_0_0RCTConvert (ABI43_0_0RNSScreen)

ABI43_0_0RCT_ENUM_CONVERTER(
                   ABI43_0_0RNSScreenStackPresentation,
                   (@{
                     @"push" : @(ABI43_0_0RNSScreenStackPresentationPush),
                     @"modal" : @(ABI43_0_0RNSScreenStackPresentationModal),
                     @"fullScreenModal" : @(ABI43_0_0RNSScreenStackPresentationFullScreenModal),
                     @"formSheet" : @(ABI43_0_0RNSScreenStackPresentationFormSheet),
                     @"containedModal" : @(ABI43_0_0RNSScreenStackPresentationContainedModal),
                     @"transparentModal" : @(ABI43_0_0RNSScreenStackPresentationTransparentModal),
                     @"containedTransparentModal" : @(ABI43_0_0RNSScreenStackPresentationContainedTransparentModal)
                    }),
                   ABI43_0_0RNSScreenStackPresentationPush,
                   integerValue)

ABI43_0_0RCT_ENUM_CONVERTER(
                   ABI43_0_0RNSScreenStackAnimation,
                   (@{
                     @"default" : @(ABI43_0_0RNSScreenStackAnimationDefault),
                     @"none" : @(ABI43_0_0RNSScreenStackAnimationNone),
                     @"fade" : @(ABI43_0_0RNSScreenStackAnimationFade),
                     @"fade_from_bottom" : @(ABI43_0_0RNSScreenStackAnimationFadeFromBottom),
                     @"flip" : @(ABI43_0_0RNSScreenStackAnimationFlip),
                     @"simple_push" : @(ABI43_0_0RNSScreenStackAnimationSimplePush),
                     @"slide_from_bottom" : @(ABI43_0_0RNSScreenStackAnimationSlideFromBottom),
                     @"slide_from_right" : @(ABI43_0_0RNSScreenStackAnimationDefault),
                     @"slide_from_left" : @(ABI43_0_0RNSScreenStackAnimationDefault),
                    }),
                   ABI43_0_0RNSScreenStackAnimationDefault,
                   integerValue)

ABI43_0_0RCT_ENUM_CONVERTER(
                   ABI43_0_0RNSScreenReplaceAnimation,
                   (@{
                     @"push" : @(ABI43_0_0RNSScreenReplaceAnimationPush),
                     @"pop" : @(ABI43_0_0RNSScreenReplaceAnimationPop),
                    }),
...
#if !TARGET_OS_TV
ABI43_0_0RCT_ENUM_CONVERTER(
                   ABI43_0_0RNSStatusBarStyle,
                   (@{
                     @"auto" : @(ABI43_0_0RNSStatusBarStyleAuto),
                     @"inverted" : @(ABI43_0_0RNSStatusBarStyleInverted),
                     @"light" : @(ABI43_0_0RNSStatusBarStyleLight),
                     @"dark" : @(ABI43_0_0RNSStatusBarStyleDark),
                    }),
